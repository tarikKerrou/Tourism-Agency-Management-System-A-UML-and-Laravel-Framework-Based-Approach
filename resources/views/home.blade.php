                ...
                <div class="main-header">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-10">
                         ...
                         <li class="active"><a href="http://127.0.0.1:8000/redirect">Home</a></li>
                                <li><a href="services.html">Services</a></li>
                                <li><a href="events.html">Events</a></li>
                                <li><a href="about.html">About Us</a></li>
                                <li><a href="contact.html">Contact</a></li>
                                <li><a href="http://127.0.0.1:8000/reserved">Reservations</a></li>
                    ...
                    <div class="col-md-12 visible-sm visible-xs">
                        <div class="menu-responsive">
                            <ul>
                                ...
                                <li><a href="about.html">About Us</a></li>
                                <li><a href="contact.html">Contact</a></li>
                                <li><a href="{{ route('panier') }}">Reservation</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-lg-4">
                                <div class="flex-caption visible-lg">
                                    ...
                                    <p> Explore the Beauty of the Beautiful World 
...
-->
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <li><a href="https://facebook.com/" class="fa fa-facebook"></a></li>
                            ...
                            <li><a href="https://flickr.com/" class="fa fa-flickr"></a></li>
